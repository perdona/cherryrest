...
class TimestampMixin(object):
    created_at = Column(Integer, default=lambda: UTC.localize(datetime.datetime.now()))
    updated_at = Column(Integer, default=lambda: UTC.localize(datetime.datetime.now()), onupdate=lambda: UTC.localize(datetime.datetime.now()))
